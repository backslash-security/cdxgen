...
import frameworksListJson from "../../data/frameworks-list.json" with {
  type: "json",
};
import CPP_STD_MODULES from "../../data/glibc-stdlib.json" with {
  type: "json",
};
import knownLicenses from "../../data/known-licenses.json" with {
  type: "json",
};
import licenseMapping from "../../data/lic-mapping.json" with {
  type: "json",
};
import spdxLicenses from "../../data/spdx-licenses.json" with {
  type: "json",
};
import vendorAliases from "../../data/vendor-alias.json" with {
  type: "json",
};
import mesonWrapDB from "../../data/wrapdb-releases.json" with {
  type: "json",
};
...
import PYTHON_STD_MODULES from "../../data/python-stdlib.json" with {
  type: "json",
};

// Mapping between modules and package names
import PYPI_MODULE_PACKAGE_MAPPING from "../../data/pypi-pkg-aliases.json" with {
  type: "json",
};
...
import RUBY_KNOWN_MODULES from "../../data/ruby-known-modules.json" with {
  type: "json",
};
